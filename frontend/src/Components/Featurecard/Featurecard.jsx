...
function Featurecard() {
    return (
        <div className="featCard br1 bg-white d-flex flex-column p-2 me-2">
            <div className="cardHeadTxt ebrima-bold">
            ...
            <div className="cardBodyTxt d-flex mt-3 align-items-center">
                ...
                <div className="cardBodyTxt">
                    <p className="mb-0 cardBodyTitle ebrima-bold text-primary fs-4">10% flat off</p>
                    <p className="mb-0 cardBodyDesc ebrima-regular text-secondary fs-6 m-0 p-0">On all bookings</p>
                </div>
            </div>
            <div className="cardLink d-flex align-items-center justify-content-between ps-1 pe-2 mt-2">
                <p className='cardLinkP mb-0 ebrima-bold'><a href="https://www.google.com" className="nav-link ebrima-bold">This is the Link</a></p><i className="fas fa-arrow-right text-primary"></i>
            </div>
        </div>
    );
};
