        ...
        <div className="footerDiv">
            ...
            <div className="footerInfo container p-0 d-flex justify-content-center flex-wrap mt-4">
                <div className="footerCard text-center  p-2">
                    <p className="cardHead mb-0 outfit-black"><a href="tel:+918928060714" className="nav-link"><i className="fas fa-phone-alt fs-1 mb-1 text-primary"></i></a></p>
                ...
                <div className="footerCard text-center  p-2">
                    <p className="cardHead mb-0 outfit-black"><span className="nav-link"><i className="fas fa-map-marker-alt fs-1 mb-1 text-primary"></i></span></p>
                ...
                <div className="footerCard text-center  p-2">
                    <p className="cardHead mb-0 outfit-black"><a href="mailto:caronrent.co@gmail.com" className="nav-link"><i className="fas fa-envelope fs-1 mb-1 text-primary"></i></a></p>
