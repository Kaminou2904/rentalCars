    ...
    <div className='mainDetail'>
        ...
        <div className="carData container">
            <div className="carDataWrap mt-2">
                <div className="carTitle fs-3">
                    <p className="carTitleTxt ebrima-bold mb-0">Toyota Fortuner <span className="modelTxt text-muted fs-6 fw-bolder">2018</span></p>
        ...
        <div className="ratingDiv container">
            <div className="ratingWrap">
                <p className="ratingTxt text-muted mt-1 ebrima-bold mb-0"><span className="ratingSpan text-dark px-1 pe-2 py-1 bg-brand rounded-pill "><i className="fas fa-star text-warning"></i> 4.5</span> 342 Review . 398 kms driven</p>
            </div>
        </div>

        <div className="bookingDetail container mt-4">
            <p className="bookingHead ebrima-bold mb-0 fs-5">Booking Time</p>
            <div className="bookingWrap mt-1">
                <div className="bookingCard bg-brand br2 p-3 d-flex justify-content-between align-items-center">
                    <div className="startDateCont text-start">
                        ...
                        <p className="startDateDate mb-0 ebrima-bold">21 Aug</p>
                    </div>
                    ...
                    <div className="endDateCont text-end">
                        ...
                        <p className="endDateDate mb-0 ebrima-bold">23 Aug</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="aboutCarDiv container mt-4">
            <p className="aboutHead ebrima-bold mb-0 fs-5">About the car</p>
